...
gqlclient = Client(transport=transport, fetch_schema_from_transport=True, execute_timeout=300)
...
df_Overall = df[["annictId", "id", "ratingOverallState", "title", "titleKana", "watchersCount", "reviewsCount"]]
df_Overall = df_Overall.dropna()
df_Music = df[["annictId", "id", "ratingMusicState", "title", "titleKana", "watchersCount", "reviewsCount"]]
df_Music = df_Music.dropna()
df_Story = df[["annictId", "id", "ratingStoryState", "title", "titleKana", "watchersCount", "reviewsCount"]]
df_Story = df_Story.dropna()
df_Animation = df[["annictId", "id", "ratingAnimationState", "title", "titleKana", "watchersCount", "reviewsCount"]]
df_Animation = df_Animation.dropna()
df_Character = df[["annictId", "id", "ratingCharacterState", "title", "titleKana", "watchersCount", "reviewsCount"]]
